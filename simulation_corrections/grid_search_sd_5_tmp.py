...
for _ in range(2):
    ...
    window = secure_random.choice([300, 300, 300, 300, 1000])
    if window == 1:
        correction = 0
    elif window == 3:
        ...
        correction = secure_random.choice([0.9, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6])
    elif window == 1000:
        correction = secure_random.choice([2.1, 2.2, 2.3])
