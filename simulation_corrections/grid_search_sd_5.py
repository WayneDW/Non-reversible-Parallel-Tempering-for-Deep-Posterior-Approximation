...
for _ in range(10):
    ...
    if window == 1:
        ...
        correction = secure_random.choice([1.0, 1.2, 1.4])
    elif window == 30:
        correction = secure_random.choice([1.0, 1.2, 1.4, 1.6])
    elif window == 100:
        correction = secure_random.choice([1.1, 1.3, 1.5, 1.7])
    elif window == 300:
        correction = secure_random.choice([2.5, 2.7, 2.9, 3.1])
    elif window == 1000:
        correction = secure_random.choice([3.4, 3.6, 3.8, 4.0])
