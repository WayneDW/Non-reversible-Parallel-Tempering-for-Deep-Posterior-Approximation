...
for _ in range(40):
    ...
    if window == 1:
        ...
        correction = secure_random.choice([0.20, 0.22, 0.24, 0.26, 0.28, 0.30, 0.32, 0.34, 0.36, 0.38, 0.40])
    elif window == 3:
        correction = secure_random.choice([0.32, 0.34, 0.36, 0.38, 0.40, 0.42, 0.44])
    elif window == 10:
